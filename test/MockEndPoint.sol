...
contract MockEndpoint is IEndpointV2 {
    ...
    function quote(uint32 /* dstEid */, bytes calldata /* message */, bool /* payInZRO */, bytes calldata /* adapterParams */) external pure override returns (uint256 nativeFee, uint256 zroFee) {
    ...
    function getEid() external pure override returns (uint32) { return 40204; }  // Mock Monad ID.
}